...
<section class="myCarousel-slider">
  <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
    ...
    <?php $loop = new WP_Query( array( 'post_type' => 'slider', 'posts_per_page' => 2, 'order' => 'ASC' ) );
    $i = 0;
    ...
    <?php else: ?>
      <div class="item">
    <?php endif; ?>
        <img class="d-block img-fluid" src="<?php the_post_thumbnail_url('full') ?>" width="100%" height="800px" >
